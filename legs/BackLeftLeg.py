...
class BackLeftLeg(SimpleLegForFindingPoses):
    ...
    def __init__(self):
        ...
        self.servoArray = [Servo(1), Servo(2), Servo(3)]
        ...
        self.inverseKinematicChain = RobotChain.createChain(-39.5, -100.0, 3.0 * math.pi / 4.0, self.legSegmentMatrix, self.servoOrientationMatrix, self.lowerLegSegmentArray)
